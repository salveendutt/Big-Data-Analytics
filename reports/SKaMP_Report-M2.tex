...
Below we present the NiFi flows for the data acquisition, processors failures are retried 10 times, errors are logged with LogMessage processor with level 'error'. The first flow is the overview of the whole process, the three processor groups are responsible for fetching and processing the data. Inside each of the processor groups there are:
\begin{itemize}
